...
function add_time($conn,$seconds,$CustomerID=1){
...
function sub_time($conn,$seconds,$CustomerID=1){
...
if($_POST['action']==='reset'){
    $stmt=$conn->prepare("UPDATE Accounts SET Allowance='10:00:00' WHERE CustomerID=1");
    $stmt->execute();
    header("Location: parent_view.php"); exit();
}
